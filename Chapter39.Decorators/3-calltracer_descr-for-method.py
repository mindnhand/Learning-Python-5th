...
class Wrapper:
    def __init__(self, desc, subj):             # save both instance
        print('in Wrapper class __init__')
        self.desc = desc                        # route calls back to deco/desc
        self.subj = subj
    def __call__(self, *args, **kwargs):
        print('in Wrapper class __call__')
        return self.desc(self.subj, *args, **kwargs)        # return tracer.__call__
...
if __name__ == '__main__':
    ...
    '''
    Execution results:
    Chapter39.Decorators]# python3 3-calltracer_descr-for-method.py
    ...
    in Wrapper class __init__
    in Wrapper class __call__
    in property descriptor __call__
    call 1 to giveRaise
