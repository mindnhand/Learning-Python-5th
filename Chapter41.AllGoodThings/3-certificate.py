...
#----------------------------------------------------
# Usage: python3 
# Description: generate a web html file
#----------------------------------------------------
...
Generate a bare-bones class completion certificate: printed, and saved in text
and html files displayed in a web browser.
"""
...
# Make textfile version 1
#with open(saveto, 'w') as of:
#    text = template % (sept, date, name, book, sept)
#    print(text, file=of)
