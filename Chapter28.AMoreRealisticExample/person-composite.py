...
#-----------------------------------------------------
# Usage: python3 person-composite.py
# Description: Implement a class, Embedding-based Manager alternative
#-----------------------------------------------------
...
class Manager(Person):
    ...
    def __getattr__(self, attr):
        return getattr(self.person, attr)                           # Delegate all others attrs
    def __repr__(self):
...
if __name__ == '__main__':
    ...
    print('--After add Department class--')
    development = Department(bob, sue)                  # Embeded objects in a composite
    development.addMember(tom)
    development.giveRaise(.10)                          # Runs embeded objects' giveRaise
    development.showAll()                               # Runs embeded objects' __repr__
